...
Derivation of [Empirical Bayes Multiscale Poisson Matrix Factorization](EBMPMF.pdf)
...
4. [Smoothed EBPMF](SmoothPMF.html): Wavelet Smoothing + EBPMF (ad-hoc)
5. [Sparse NMF methods](nmfsparse.html): Try some esixting sparse NMF methods.

### PTF

1. [Poisson Trend Filtering](PoissonTrendFiltering.html)
