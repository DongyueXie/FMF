...
```{r}
ploter.flash = function(fit_flash,k=1,p){
  par(mfrow=c(1,1))
  plot(fit_flash$loadings.pm[[1]][,k],pch=20,xlab='individuals',ylab='',main=paste('loading ',k))
...
ploter.flash(fit_flash,1,127827)
ploter.flash(fit_flash,2,127827)
ploter.flash(fit_flash,3,127827)
ploter.flash(fit_flash,4,127827)
ploter.flash(fit_flash,5,127827)
```
...
ploter.wave.flash = function(fit_wave,k=1,p){
  par(mfrow=c(1,1))
  plot(fit_wave$ldf$l[,k],pch=20,xlab='individuals',ylab='',main=paste('loading ',k))
  #plot(fit_flash$loadings.pm[[2]][,k],type='l',xlab='locus',ylab='',main=paste('factor ',k))
  par(mfrow=c(3,1))
...
```{r,fig.width=12,fig.height=5}
ploter.wave.flash(fit_wave,1,127827)
ploter.wave.flash(fit_wave,2,127827)
ploter.wave.flash(fit_wave,3,127827)
ploter.wave.flash(fit_wave,4,127827)
ploter.wave.flash(fit_wave,5,127827)
```
