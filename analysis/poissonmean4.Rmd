---
title: "Poisson mean mixture of two gammas - closer priors"
author: "Dongyue Xie"
date: "2019-11-12"
...
fit = ebpm_gamma_mixture(x,s,shape = c(0.1,5), rate=c(1,1),nullweight = 20)
...
```{r}
tt = rbind((x/s)[790:800],
round((fit$posterior$mean)[790:800],3),round(exp(fit$posterior$mean_log),2)[790:800])
rownames(tt) = c('MLE',c('PosteriorMean','Exp(Elog)'))
colnames(tt) = 790:800
tt
```
